...
namespace Steganography
{
    public partial class SteganographyForm : Form
    {
        ...
        // โหลดไฟล์เข้า TextBox พร้อมเช็คขนาด
        /// <summary>
        ...
        // sync ciphertext จาก Encryption tab อัตโนมัติตอนเปลี่ยนแท็บ
        ...
        private void EncrytionButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                textBox1.Text = cipherBase64; // sync ไป Stegano tab
        ...
        // ปุ่ม Browser — เปิดไฟล์ .txt ใส่ InputPlaintext
        ...
        // === Steganography Tab — Embed ===

        // ปุ่ม Homoglyph Embed
        // สร้าง sub-form → ตั้ง IsEmbedMode + CipherText + CoverText → ShowDialog → เอา ResultText
        ...
        // Save Steganotext เป็นไฟล์ — ต้องใช้ UTF-8 เพื่อเก็บ invisible chars ได้ถูกต้อง
        ...
        // อัพเดต bit capacity ตอน ciphertext หรือ covertext เปลี่ยน
        ...
        // คำนวณ capacity — payload format: [32-bit length][data bits]
        /// <summary>
        ...
        private void UpdateSteganoBitCapacity()
        {
            ...
            try
            {
                ...
                int zwspSlots  = Math.Max(0, coverText.Length - 1);  // ช่องว่างระหว่างตัวอักษร
        ...
        // === Validate ก่อน Embed ===
        // auto-sync ciphertext ถ้า textBox1 ว่างแต่ InputPayload มีค่า
        ...
        // === Decryption Tab — Extract + ถอดรหัส ===

        // ปุ่ม Homoglyph Extract — เหมือน embed แต่ IsEmbedMode=false, ส่ง SteganotextInput แทน
        ...
        // ปุ่ม Decrypt ตรงจาก ciphertext (ไม่ผ่าน extract)
        ...
        // ถอดรหัส AES จาก ciphertext Base64 → plaintext
