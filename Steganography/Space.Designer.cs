namespace Steganography
{
    partial class ChkbxZWSP
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.LblTitle.Text = "Zero-Width Space (ZWSP)";
            // 
            // LblDesc
            // 
            ...
            this.LblInfo.Text = "หลักการทำงาน:\r\n" +
                "• ฝัง: วนผ่านทุกช่องระหว่างตัวอักษรใน covertext\r\n" +
                "  - bit=1 → แทรก U+200B หลังตัวอักษรนั้น\r\n" +
                "  - bit=0 → ไม่แทรกอะไร\r\n" +
                "• ถอด: ตรวจสอบว่ามี U+200B ระหว่างตัวอักษรแต่ละคู่หรือไม่\r\n" +
                "  - มี → bit=1, ไม่มี → bit=0";
            // 
            // BtnOK
            // 
            ...
            this.Name = "ChkbxZWSP";
            this.Text = "Zero-Width Space";
            this.Load += new System.EventHandler(this.ChkbxZWSP_Load);
